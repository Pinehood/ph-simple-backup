...
APPLICATION_SIZE = "500x170"

TEXT_SWITCH_TO_FILE = "Switch to file"
TEXT_SWITCH_TO_FOLDER = "Switch to folder"

TEXT_CHOOSE_FILE = "Choose file to backup"
TEXT_CHOOSE_FOLDER = "Choose folder to backup"

TEXT_CHOOSE_BACKUP_DESTINATION = "Choose backup location"
TEXT_BACKUP = "Backup"
